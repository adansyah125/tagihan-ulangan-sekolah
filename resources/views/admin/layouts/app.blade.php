...
<head>
    ...
    <title>Sistem Tagihan Ulangan| @yield('title')</title>
    ...
    <aside id="sidebar"
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="/admin/dashboard"
                class="flex items-center gap-3 px-4 py-2 rounded-lg  text-white transition {{ request()->routeIs('admin.dashboard') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
            ...
            <!-- Data Siswa -->
            <a href="/admin/siswa"
                class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-gray-700/70 text-gray-300 transition {{ request()->routeIs('admin.siswa') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div>
                ...
                <div id="menuTagihan" class="hidden ml-5 mt-2 space-y-1">
                    ...
                    <a href="/admin/tagihan/uts"
                        class="block px-4 py-2 rounded-lg text-sm hover:bg-gray-700/60 text-gray-300 transition {{ request()->routeIs('admin.tagihan.uts') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
                    ...
                    <a href="/admin/tagihan/monitor"
                        class="block px-4 py-2 rounded-lg text-sm hover:bg-gray-700/60 text-gray-300 transition {{ request()->routeIs('admin.tagihan.monitor') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
                        <span class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                ...
                <div id="menuLaporan" class="hidden ml-5 mt-2 space-y-1">
                    <a href="/admin/laporan/keuangan"
                        class="block px-4 py-2 rounded-lg text-sm hover:bg-gray-700/60 text-gray-300 transition {{ request()->routeIs('admin.laporan.keuangan') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
                    ...
                    <a href="/admin/laporan/tagihan"
                        class="block px-4 py-2 rounded-lg text-sm hover:bg-gray-700/60 text-gray-300 transition {{ request()->routeIs('admin.laporan.tagihan') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700/70 text-gray-300' }}">
                        <span class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="flex-1 flex flex-col min-h-screen md:ml-64">
        ...
        <header
            ...
            <div class="flex items-center gap-4 ml-auto">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-10 h-10 rounded-full">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg>
